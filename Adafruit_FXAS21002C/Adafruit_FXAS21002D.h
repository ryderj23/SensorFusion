/*!
 * @file Adafruit_FXAS21002D.h
 *
 * This is part of Adafruit's FXAS21002D driver for the Arduino platform.  It
 * is designed specifically to work with the Adafruit FXAS21002D breakout:
 ...
 *
 */
#ifndef __FXAS21002D_H__
#define __FXAS21002D_H__

#include <Adafruit_BusIO_Register.h>
#include <Adafruit_I2CDevice.h>
#include <Adafruit_Sensor2.h>
#include <Arduino.h>
...
// #define FXAS21002D_ADDRESS (0x21) // 0100001
/** Device ID for this sensor (used as a sanity check during init) */
#define FXAS21002D_ID (0xD7) // 1101 0111
...
/**************************************************************************/
/*!
    @brief  Unified sensor driver for the Adafruit FXAS21002D breakout.
*/
/**************************************************************************/
class Adafruit_FXAS21002D : public Adafruit_Sensor {
public:
  Adafruit_FXAS21002D(int32_t sensorID = -1);
  ~Adafruit_FXAS21002D();
  bool begin(uint8_t addr = 0x21, TwoWire *wire = &Wire1);
